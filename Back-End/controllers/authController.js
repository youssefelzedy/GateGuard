...
exports.signup = catchAsync(async (req, res, next) => {
  // Validate required fields for both garage and admin
  const {
    garageName,
    name,
    email,
  ...
  try {
    ...
    // 2. Create the admin with Owner role and link to the garage
