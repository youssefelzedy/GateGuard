...
function DeleteModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div
                ref={modalRef}
                className="relative w-full max-w-md animate-fadeSlideUp overflow-hidden rounded-lg bg-primary-50 p-8 shadow-lg transition-all duration-500"
                role="dialog"
                aria-modal="true"
            >
                <button
                ...
                <div className="text-center">
                    ...
                    <div className="flex justify-center gap-4">
                        ...
                        <button
                            onClick={onConfirm}
                            className="rounded-md bg-red-500 px-4 py-2 text-white transition hover:bg-red-600 disabled:opacity-50"
                            disabled={isDeleting}
                        >
